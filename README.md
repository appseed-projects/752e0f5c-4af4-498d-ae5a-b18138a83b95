...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-06 01:53`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/752e0f5c-4af4-498d-ae5a-b18138a83b95.git
$ cd 752e0f5c-4af4-498d-ae5a-b18138a83b95
```
